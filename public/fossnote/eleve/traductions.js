...
a("Onglet.Libelle", "Bilan de fin de cycle");
...
a("Onglet.LibelleLong", "");
a("Onglet.LibelleLong", "Mon relevé de notes");
a("Onglet.LibelleLong", "");
a("Onglet.LibelleLong", "");
...
a("LienPolitiqueMotDePasse.UrlFAQMotDePasse", "https://swie.index-education.com/redirect.php?produit=pn&page=comment-renforcer-securite&version=2026.2.6.0&distrib=FR&lg=fr&flag=Espace_Eleve&type=LienDocProduit");
...
a("RecapAbsenceEleve.SelectionnerUnRecap", "Sélectionner un récapitulatif");
...
a("DernieresNotes.Detail.WAIComboDevoir", "Sélectionnez un devoir");
a("DernieresNotes.Detail.WAIComboService", "Sélectionnez un service");
...
a("$GlossaireMediaCentre", (b) => {
  a(`${b}.ToutesCategories`, "Toutes les ressources");
  a(`${b}.ListeVide`, "Sélectionner une ressource");
  a(`${b}.AucuneRessource`, "Aucune ressource trouvée");
  a(`${b}.Consulter`, "Consulter");
  a(`${b}.ConsulterLienExterne`, "Consulter le lien de la ressource dans un nouvel onglet");
});
