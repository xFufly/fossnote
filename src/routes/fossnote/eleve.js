...
router.get('/', async (req, res) => {
  ...
  const session_params = {
    ...
    a: 3,
    d: false,
    // MR: rsaData.publicKeyModulus, // Old fossnote versions
    // ER: rsaData.publicKeyExponent // Old fossnote versions
  };
  ...
  const file_path = path.join(__dirname, '../../views/fossnote/eleve.html');
