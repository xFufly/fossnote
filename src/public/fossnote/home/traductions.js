  ...
  f: function (exports, require, module, global) {
    ...
    module.exports = function (a) {
      ...
      a(
        ...
        "Activez l'édition avec les touches majuscule + entrée. "
      );
      a(
      ...
      a(
        ...
        "Menu: Alt + Maj + 0, Commande: Alt + Maj + 1, Contenu: Alt + Maj + 2, Déconnexion: Alt + Maj + 9"
      );
      a(
      ...
      a("PiedPage.CookieInfo_Message_2", "Pour plus d'infos, voir nos");
      ...
      a(
        "QCM_Divers.CliquerPourSelectionnerReponse",
        "Cliquer pour sélectionner une réponse"
      );
      a("QCM_Divers.AucuneReponseSelectionnee", "Aucune réponse sélectionnée");
      a(
      ...
      a("Onglet.Libelle", "Carnet de la classe");
      ...
      a("Onglet.Libelle", "Evolution annuelle de l'élève");
      ...
      a("Onglet.Libelle", "Mon tableau de bord");
      ...
      a("Onglet.Libelle", "Synthèse des acquis");
      ...
      a(
        ...
        "Liste déroulante : sélectionnez une période."
      );
      a(
        "WAI.ListeSelectionMatiere",
        "Liste déroulante : sélectionnez une matière."
      );
      a(
        "WAI.ListeSelectionPartieJournee",
        "Liste déroulante : sélectionnez la partie de journée."
      );
      ...
      a(
        ...
        "Liste des inspecteurs pédagogiques"
      );
      ...
      a(
        "AvertissementDemo",
        "Ce site est une version de démonstration de FOSSNOTE Primaire.\nPour consulter vos données personnelles vous devez vous connecter à l'adresse fournie par votre établissement."
      );
      a("mobile.bandeauIOS1", "Installer ou configurer l'application FOSSNOTE");
      a("mobile.storeTextIOS", "Télécharger l'application FOSSNOTE");
      a(
        "mobile.bandeauAndroid1",
        "Installer ou configurer l'application FOSSNOTE"
      );
      ...
      a("Commande.TelechargerClient.Actif", "Télécharger le Client FOSSNOTE");
      a("Commande.SuivrePronoteTwitter.Actif", "Suivre FOSSNOTE sur Twitter");
      ...
      a(
        ...
        "Connexion à FOSSNOTE.net - Veuillez patienter..."
      );
      ...
      a(
        "WAI.raccourciAccessible",
        "Cliquer CTRL+MAJ+X pour basculer le mode accessible."
      );
      ...
      a(
        "accueil.CDC.colonne.hint.apprManquantes",
        "Nombre d'appréciations manquantes de la classe"
      );
      ...
      a(
        ...
        "Saisir les appréciations manquantes"
      );
      a("accueil.CDC.hint.aucunServiceNote", "Service non noté");
      a("accueil.CDC.hint.clotureDevoir", "La saisie des notes est clôturée");
      a(
        "accueil.CDC.hint.dateClotureDevoir",
        "la saisie des notes sera clôturée le %s"
      );
      a(
        "accueil.CDC.hint.clotureEval",
        "La saisie des évaluations est clôturée"
      );
      a(
        "accueil.CDC.hint.dateClotureEval",
        "la saisie des évaluations sera clôturée le %s"
      );
      a(
        "accueil.CDC.hint.clotureAppreciation",
        "La saisie des appréciations est clôturée"
      );
      a(
        "accueil.CDC.hint.dateClotureAppreciation",
        "la saisie des appréciations sera clôturée le %s"
      );
      ...
      a(
        ...
        "QCM de la bibliothèque de l'établissement et QCM Nathan"
      );
      ...
      a(
        ...
        "En t'inscrivant, tu autorises FOSSNOTE à diffuser à %s les informations suivantes :"
      );
      a(
      ...
      a("accueil.tableauDeBord.titre", "Elèves absents");
      ...
      a("accueil.prochainsCours", "3 prochains cours");
      ...
      a("Mobile.Menu.Ecrire", "Ecrire");
      a("Mobile.Menu.Chatter", "Tchatter");
      a("Mobile.Menu.Prevenir", "Prévenir");
      a("Accueil.ParametresWidgets", "Paramètres des widgets");
      a(
        "accueil.hint.fermer",
        "Fermer ce widget (vous pourrez le réafficher à partir de la roue crantée)"
      );
      ...
      a("actualites.partagerModele", "Partager le modèle");
      a("actualites.nePasPartagerModele", "Ne pas partager le modèle");
      ...
      a("actualites.CreerBrouillon", "Créer le brouillon");
      ...
      a("actualites.Edition.DupliquerQu", "Dupliquer la question");
      a("actualites.Edition.DupliquerTxt", "Dupliquer le texte");
      ...
      a(
        ...
        'Proposer un choix "Autre" pour permettre la rédaction d\'un commentaire'
      );
      ...
      a(
        "actualites.Edition.FiltreRepondu",
      ...
      a(
        "actualites.detailPartageSondage",
        "%s accède au sondage en consultation"
      );
      a(
        "actualites.detailPartageSondageN",
        "%s personnes accèdent au sondage en consultation"
      );
      ...
      a(
        "menus.Message.AucunMenuSurSemaine",
        "Aucun menu n'a été saisi pour cette semaine"
      );
      ...
      a(
        ...
        "Calcul du niveau de maîtrise du domaine"
      );
      a(
      ...
      a(
        ...
        "Les points attribués à chaque niveau de maîtrise dans votre école sont les suivants :"
      );
      a(
      ...
      a(
        ...
        "Sélectionnez les compétences à évaluer"
      );
      ...
      a(
        "competences.CompetenceNonAffectee",
        "%s (la compétence n'est pas affectée à sa classe)"
      );
      ...
      a(
        ...
        "Représentation graphique du positionnement par matière"
      );
      a(
        "competences.pasDAffichageGraphe",
        "Pour afficher le graphe de l'élève, celui-ci doit être évalué dans au moins 3 compétences."
      );
      a(
      ...
      a(
        "competences.ItemsNOntPasEteValides",
        "Des items n'ont pas été validés car le niveau de maîtrise n'est pas actif."
      );
      ...
      a("competences.NbPointsObtenus", "Nb Pts");
      a(
      ...
      a("competences.MatiereDEnseignementDeComplement", "Matière");
      a(
      ...
      a("SuiviResultatsCompetences.colonnes.Items", "Items");
      a("SuiviResultatsCompetences.colonnes.Jauge", "Évaluations");
      a("SuiviResultatsCompetences.colonnes.Eleves", "Élèves");
      a(
      ...
      a(
        ...
        "Nombre de compétences non maîtrisées"
      );
      a(
      ...
      a(
        "SuiviResultatsCompetences.fenetreOptionsAff.CompetencesNonMaitrisees",
        "Compétences non maîtrisées"
      );
      a(
        "SuiviResultatsCompetences.fenetreOptionsAff.CompetencesMaitrisees",
        "Compétences maîtrisées"
      );
      a(
        "SuiviResultatsCompetences.fenetreOptionsAff.EchecCompetenceSi",
        "Une compétence est considérée comme non maîtrisée si :"
      );
      a(
        "SuiviResultatsCompetences.fenetreOptionsAff.SuccesCompetenceSi",
        "Une compétence est considérée comme maîtrisée si :"
      );
      a("SuiviResultatsCompetences.fenetreOptionsAff.AuMoins", "au moins");
      a(
        "SuiviResultatsCompetences.fenetreOptionsAff.PourcentageEvalsCompEvaluees",
        "% des évaluations ont le niveau %s"
      );
      a(
        "SuiviResultatsCompetences.fenetreOptionsAff.ElementsUtilisesDansCalcul",
      ...
      a("FicheStage.profReferent", "Professeur référent");
      a("FicheStage.profsReferents", "Professeurs référents");
      a("FicheStage.pasDeSujetDetaille", "Pas de sujet détaillé ...");
      a(
      ...
      a(
        ...
        "Publier sur les Espaces Parents et Elèves"
      );
      a(
        "FicheStage.listeSuivis.hintPublication",
        "Publiée sur les Espaces parents et élèves"
      );
      ...
      a(
        "iCal.fenetre.titreFichier",
        "Cliquez sur le lien ci-dessous pour télécharger le fichier iCal  de l'emploi du temps tel qu'il est actuellement (il ne sera pas mis à jour automatiquement)"
      );
      a(
        "iCal.fenetre.titreFichier",
        "Cliquez sur le lien ci-dessous pour télécharger le fichier iCal  de l'agenda tel qu'il est actuellement (il ne sera pas mis à jour automatiquement)"
      );
      a(
        "iCal.fenetre.QRCode",
        "Vous pouvez aussi utiliser le code ci-dessous pour récupérer l'adresse"
      );
      a(
      ...
      a("iCal.fenetre.salles.semainesPubliees", "Les 5 semaines à venir");
      a(
      ...
      a(
        ...
        "Copiez l'adresse ci-dessous dans votre \"gestionnaire d'agenda\" pour le synchroniser avec FOSSNOTE (votre emploi du temps sera mis à jour en temps réel)"
      );
      a(
        "iCal.fenetre.titreLienPermanent",
        "Copiez l'adresse ci-dessous dans votre \"gestionnaire d'agenda\" pour le synchroniser avec FOSSNOTE (votre agenda sera mis à jour en temps réel)"
      );
      ...
      a(
        ...
        "Durée de la période des stages en semaines"
      );
      a(
      ...
      a(
        ...
        "Exporter les appréciations de stage des professeurs référents"
      );
      ...
      a(
        ...
        "Appréciations des professeurs référents"
      );
      a(
      ...
      a(
        "dossierVieScolaire.supprimerElement",
        "Voulez-vous retirer cet élément du dossier ?"
      );
      a(
        "dossierVieScolaire.supprimerDossier",
        "Voulez-vous supprimer le dossier : %s ?"
      );
      a(
        "dossierVieScolaire.suppressionPunition",
        "Attention : cette punition ne pouvant pas exister sans dossier, elle sera supprimée de votre base de données."
      );
      a(
        "dossierVieScolaire.suppressionVSDossier",
        "Ce dossier a été créé par %s. Confirmez-vous la suppression de ce dossier ?"
      );
      a(
        "dossierVieScolaire.suppressionVSElement",
        "Ce dossier a été créé par %s. Confirmez-vous la suppression de cet élément du dossier ?"
      );
      a("dossierVieScolaire.viescolaire", "la Vie Scolaire");
      a("dossierVieScolaire.professeur", "un autre professeur");
      a(
        "dossierVS.msgMotifDossierObligatoire",
        "Vous devez renseigner le motif du dossier"
      );
      ...
      a("dossierVieScolaire.discussion", "Discussion");
      a(
        "dossierVieScolaire.AfficherAnneesPrecedentes",
        "Afficher les dossiers des années précédentes"
      );
      ...
      a("dossierVS.discussionFamille", "Discussion avec la famille");
      a("dossierVS.discussionPeda", "Discussion avec l'équipe pédagogique");
      a(
        "dossierVieScolaire.fenetre.titre",
        "Création d'un dossier de suivi de la vie scolaire"
      );
      a(
      ...
      a(
        ...
        "Liste déroulante : Choisissez une date:"
      );
      ...
      a(
        "fenetreSaisiePunition.publierEspaceParent",
      ...
      a(
        ...
        "Publier la punition dans le récapitulatif de la vie scolaire sur l'Espace Parents"
      );
      a(
      ...
      a(
        "BulletinEtReleve.InfoBornesSaisie",
        "Le nombre saisi doit être compris entre %d et %d."
      );
      ...
      a(
        "BulletinEtReleve.hint.Positionnement",
        "Positionnement de l'élève sur une échelle de 1 à 4"
      );
      a(
        "BulletinEtReleve.hint.NiveauDeMaitrise",
        "Niveau de maitrise de l'élève exporté vers LSU"
      );
      a(
        "BulletinEtReleve.hintValidationAutoPositionnement",
        "Détermination du positionnement de l'élève en fonction des résultats obtenus aux évaluations"
      );
      a(
        "BulletinEtReleve.hintValidationAutoPositionnementSelonDevoirs",
        "Détermination du positionnement en fonction de la moyenne des devoirs de l'élève"
      );
      a(
        "BulletinEtReleve.hintValidationAutoNiveauDAcquisition",
        "Détermination du niveau de maitrise de l'élève en fonction des résultats obtenus aux évaluations"
      );
      a(
        "BulletinEtReleve.hintValidationAutoNiveauDAcquisitionSelonDevoirs",
        "Détermination du niveau de maitrise en fonction de la moyenne des devoirs de l'élève"
      );
      a(
        "BulletinEtReleve.hintValidationAutoMoyenneLSU",
        "Détermination de la note de l'élève exportée vers LSU en fonction des résultats obtenus aux évaluations"
      );
      a(
      ...
      a(
        "BulletinEtReleve.TransfetAppreciations.Bouton",
        "Recopier depuis le bilan périodique"
      );
      a(
        "BulletinEtReleve.TransfetAppreciations.Titre",
        "Transférer les appréciations du bilan périodique dans le bulletin de notes"
      );
      a(
        "BulletinEtReleve.TransfetAppreciations.Message",
        "Les appréciations de ce service, saisies dans le bilan périodique vont être recopiées dans le bulletin de notes. Voulez-vous continuer ?"
      );
      a(
        "BulletinEtReleve.TransfetAppreciations.Remplacer",
        "Remplacer les appréciations déjà saisies"
      );
      ...
      a("BulletinEtReleve.arialabel.Progres", "Evolution en progrès");
      a("BulletinEtReleve.arialabel.Regulier", "Evolution régulier");
      a("BulletinEtReleve.arialabel.Regression", "Evolution en régression");
      ...
      a(
        "BulletinEtReleve.hintBtnCalculECTS",
        "Calcule les ECTS en fonction de la moyenne obtenue par l'élève et du nombre d'ECTS défini pour le service"
      );
      ...
      a(
        "fenetreEnvoiEmail.unSeulDestinataire",
        "Vous ne pouvez discuter qu'avec un seul parent à la fois"
      );
      ...
      a(
        "fenetreEnvoiEmail.generique.parentsDeLaClasse",
        "Parents de la classe"
      );
      a(
        "fenetreEnvoiEmail.generique.membresCA",
        "Membres du Conseil d'Administration"
      );
      a(
        "fenetreEnvoiEmail.generique.tousResponsables",
      ...
      a(
        "fenetreCommunication.bouton.casier",
        "Déposer un document dans le casier"
      );
      a(
      ...
      a(
        ...
        "Communications (Ancienne méthode)"
      );
      a(
        "fenetreCommunication.bouton.fenetreCloud",
        "Envoyer le fichier vers un cloud"
      );
      a(
        "fenetreCommunication.bouton.fenetreGenerationPDF",
        "Générer le PDF dans un nouvel onglet"
      );
      ...
      a("infosperso.cahierDeTextes", "Cahier de textes");
      ...
      a("infosperso.Theme", "Choix du thème :");
      ...
      a(
        "infosperso.AppliquerThemeAccessible",
        "Passer les interfaces en niveaux de gris"
      );
      a("infosperso.Couleur", "Couleur");
      ...
      a(
        "infosperso.messageSignature",
        "Cette signature sera apposée sur les bilans périodiques (si l'option est choisie par votre Directeur)"
      );
      ...
      a("infosperso.Liste_PreferencesContact", "Preferences de contact");
      a("infosperso.Liste_MonProfil", "Mon profil");
      ...
      a(
        ...
        "Sélectionnez un cours pour saisir le cahier journal."
      );
      a(
      ...
      a(
        ...
        "Rien à faire les jours à venir selon les critères choisis"
      );
      a(
        "CahierDeTexte.AucunTAFSelonCriteres",
        "Rien à faire selon les critères choisis"
      );
      ...
      a(
        ...
        "À déposer dans l'Espace Élèves (4 Mo max)"
      );
      ...
      a(
        ...
        "Audio - A enregistrer sur l'Espace Elèves ( 3 min. max)"
      );
      ...
      a(
        ...
        "Evaluation de compétences programmée"
      );
      ...
      a("CahierDeTexte.TAFARendre.Eleve.RendreEnregistrement", "Enregistrer");
      a(
      ...
      a(
        ...
        "L'élève pourra déposer sa copie jusqu'au"
      );
      a(
      ...
      a(
        ...
        "Sélection des classes pour affectation"
      );
      a(
      ...
      a(
        "TypeDispenseEleveDeCours.enseignementALaMaison",
        "enseignement à la maison"
      );
      a("TypeDispenseEleveDeCours.enStage", "en stage");
      a("TypeDispenseEleveDeCours.dispense", "dispensé");
      a(
        "TypeDispenseEleveDeCours.dispensePresence",
        "dispensé présence obligatoire"
      );
      a("TypeDispenseEleveDeCours.excluEtab", "exclu de l'établissement");
      a("TypeDispenseEleveDeCours.excluClasse", "exclu de la classe");
      a("TypeDispenseEleveDeCours.mesureConservatoire", "mesure conservatoire");
      a("TypeDispenseEleveDeCours.absent", "absent");
      a("TypeDispenseEleveDeCours.detache", "détaché");
      ...
      a("Absence.TitreDispense", "Dispense");
      ...
      a(
        ...
        "J'ai pris connaissance de cet encouragement"
      );
      ...
      a(
        "AbsenceVS.AbsentAuDernierCours",
        "%s était absent au dernier cours de %s avec %s."
      );
      ...
      a("AbsenceVS.retardJustifie", "Retard justifié");
      a("AbsenceVS.absenceEnAttente", "En attente d'acceptation");
      ...
      a(
        "AbsenceVS.ObservationLueWebLe",
        "Observation lue par les parents le %s"
      );
      a("AbsenceVS.Hint.NonPublie", "Non publié");
      a(
        "AbsenceVS.Hint.PublieParentsEleves",
        "Publié automatiquement sur les Espaces Parents et Elèves"
      );
      a(
      ...
      a("AbsenceVS.VoirLesValorisations", "Voir les valorisations");
      a(
      ...
      a("AbsenceVS.titreValorisation", "Valorisation");
      a(
      ...
      a(
        ...
        "Confirmez-vous la suppression de cette valorisation ?"
      );
      ...
      a(
        "AbsenceVS.HintPublicationMemo",
        "Avec les enseignants via la feuille d'appel"
      );
      a(
        "AbsenceVS.HintPublicationMemoVS",
        "Avec tous les personnels administratifs ou de vie scolaire (ayant le droit de consulter les mémos de vie scolaire)"
      );
      a(
        "AbsenceVS.HintValorisation",
        "Mémo valorisant l'éléve, automatiquement partagé avec tous les acteurs de l'établissement"
      );
      a("AbsenceVS.HintAfficherToutMemo", "Afficher tous les mémos");
      a("AbsenceVS.HintFiltrerMemo", "Masquer les mémos ayant expiré");
      a(
        "AbsenceVS.HintAfficherToutValorisation",
        "Afficher tous les mémos de valorisation"
      );
      a(
        "AbsenceVS.HintFiltrerValorisation",
        "Masquer les mémos de valorisation passés"
      );
      a("AbsenceVS.PublieSurLaFeuilleDAppel", "Publié sur la feuille d'appel");
      a(
        "AbsenceVS.AEtePublieSurLaFeuilleDAppel",
        "A été publié sur la feuille d'appel"
      );
      a(
      ...
      a("AbsenceVS.PrevenirAbsenceParentPrim", "Prévenir d'une absence");
      a("AbsenceVS.Du", "Du");
      a("AbsenceVS.Au", "Au");
      a(
      ...
      a("FicheEleve.visibleParEleves", "visible par les éléves");
      ...
      a(
        "FicheEleve.nonConsultable",
        "N'est pas consultable par l'équipe pédagogique"
      );
      a("FicheEleve.titreAmenagements", "Aménagements mis en place");
      a("FicheEleve.aPartir", "à partir du %s");
      a("FicheEleve.jusquau", "jusqu'au %s");
      a("FicheEleve.publieFamille", "Publié sur l'espace Parents");
      a(
        "FicheEleve.UniquementMetaMatiere",
        "Uniquement les aménagements communs et liés à ma discipline"
      );
      a("FicheEleve.INE", "INE");
      ...
      a("FicheEleve.SituationProfessionnelle", "Situation profesionnelle");
      a(
      ...
      a(
        "Notes.Bouton.ParametresServices",
        "Paramètres des services et sous-services"
      );
      ...
      a(
        "EquipePedagogique.profNEnseignePasAClasse",
        "Cet enseignant n'enseigne pas à la classe"
      );
      a(
        "EquipePedagogique.personnelNEnseignePasAClasse",
        "Cet personnel n'enseigne pas à la classe"
      );
      a(
        "Orientation.Ressources.DemandeStagePasserelle",
        "Demande d'un stage passerelle"
      );
      a(
        "Orientation.Ressources.StagePasserellePropose",
        "Stage passerelle proposé"
      );
      a(
      ...
      a("TvxIntendance.colonne.lieuPrimaire", "Lieu");
      ...
      a("TvxIntendance.colonne.echeance", "Échéance");
      a("TvxIntendance.colonne.niveauUrgence", "Niv. d'urgence");
      a("TvxIntendance.colonne.recepLe", "Reçue le");
      a("TvxIntendance.fenetre.niveauUrgence", "Niveau d'urgence");
      a("TvxIntendance.fenetre.echeance", "Échéance le");
      a("TvxIntendance.fenetre.dateRealisation", "Date de réalisation");
      a("TvxIntendance.fenetre.dateReception", "Date de réception");
      a("TvxIntendance.fenetre.demanderA", "Demander à");
      ...
      a("TvxIntendance.TitreCreation", "Créer une demande");
      a(
      ...
      a(
        ...
        "Créer une nouvelle demande de tâche"
      );
      a("TvxIntendance.TitreCreationCommandes", "Créer une nouvelle commande");
      a("TvxIntendance.CreationCommande", "Créer une commande");
      a("TvxIntendance.TitreDemandeRealisee", "Demande réalisée");
      a("TvxIntendance.TitreCommandeReceptionnee", "Reçue le");
      a("TvxIntendance.TitreModification", "Modifier la demande de travaux");
      a("TvxIntendance.TitreModificationCommande", "Modification de commande");
      a("TvxIntendance.TitreTraiterCommande", "Traiter une commande");
      a("TvxIntendance.TitreTraiterDemande", "Traiter une demande");
      a("TvxIntendance.TitreModifierCommande", "Modifier ma commande");
      a("TvxIntendance.TitreModifierDemande", "Modifier ma demande");
      a("TvxIntendance.TitreSurColonne.Demande", "Demande");
      a("TvxIntendance.TitreSurColonne.Commande", "Commande");
      ...
      a("TvxIntendance.FenetreSelectionLieu_TitrePrimaire", "Lieu");
      ...
      a("TvxIntendance.Hint.SupprimerDemande", "Supprimer la demande");
      a("TvxIntendance.Hint.SupprimerCommande", "Supprimer la commande");
      a(
      ...
      a(
        ...
        'Voulez-vous vraiment transférer la tâche sélectionée de "%s" vers "%s"'
      );
      a("TvxIntendance.TransfererVers", 'Tranférer la sélection vers "%s"');
      a(
      ...
      a(
        ...
        "Les notes de ce service ne sont pas publiées sur les Espaces Elève et Parent"
      );
      a(
        "FenetreDevoir.DecalageUnJourPublicationParentsSoitLe",
        "Conformément au choix de l'établissement, la note sera publiée aux parents un jour après la publication aux élèves, soit le %s"
      );
      a(
        "FenetreDevoir.DecalageXJoursPublicationParentsSoitLe",
        "Conformément au choix de l'établissement, la note sera publiée aux parents %d jours après la publication aux élèves, soit le %s"
      );
      a(
      ...
      a(
        ...
        "%d questions n'ont pas été exportées car elles sont sous copyright Nathan."
      );
      a(
      ...
      a(
        ...
        "Signale la présence dans la bibliothèque de l'école pour le partager avec les autres enseignants"
      );
      ...
      a(
        ...
        "Le temps de réponse était limité à %d"
      );
      a(
      ...
      a(
        ...
        "questions prises au hasard pour chaque élève"
      );
      a(
      ...
      a(
        ...
        "Partager avec les autres enseignants via la bibliothèque de l'école"
      );
      ...
      a("QCM_Divers.uploadCloud", "Envoyer mes QCM vers mon Cloud FOSSNOTE");
      a(
        "QCM_Divers.uploadCloudArrierePlan",
        "Le transfert est en cours, une notification vous informera du résultat de l'export."
      );
      a(
        "QCM_Divers.InfoReponseNumerique",
        "La réponse de l'élève sera prise en compte indépendamment des séparateurs numériques (point, virgule, ...) et des espaces"
      );
      a(
      ...
      a(
        "OffreStage.EditInterdit_Auteur",
        "Vous n'êtes pas l'auteur de cette offre de stage"
      );
      ...
      a("TypeNiveauEquivalenceCE.LVE.niveau_3", "A2+");
      a("TypeNiveauEquivalenceCE.LVE.long_niveau_3", "Niveau A2+");
      a("TypeNiveauEquivalenceCE.LVE.niveau_4", "B1");
      a("TypeNiveauEquivalenceCE.LVE.long_niveau_4", "Niveau B1");
      a("TypeNiveauEquivalenceCE.LVE.niveau_5", "B1+");
      a("TypeNiveauEquivalenceCE.LVE.long_niveau_5", "Niveau B1+");
      a("TypeNiveauEquivalenceCE.LVE.niveau_6", "B2");
      a("TypeNiveauEquivalenceCE.LVE.long_niveau_6", "Niveau B2");
      a("TypeNiveauEquivalenceCE.LVE.niveau_7", "C1");
      a("TypeNiveauEquivalenceCE.LVE.long_niveau_7", "Niveau C1");
      a("TypeNiveauEquivalenceCE.LVE.niveau_8", "C2");
      a("TypeNiveauEquivalenceCE.LVE.long_niveau_8", "Niveau C2");
      ...
      a(
        "TypeModeCalculPositionnementService.libelle.ModeCalculNMeilleursEvals",
        "Mode 3"
      );
      a(
      ...
      a(
        ...
        "Positionnement calculé à partir des niveaux de maîtrise affichés"
      );
      a(
        "TypeModeCalculPositionnementService.explication.PosCalculeAPartirDe",
        "Positionnement calculé à partir des"
      );
      a(
        "TypeModeCalculPositionnementService.explication.ModeCalculNDernieresEvals",
        "dernières évaluations"
      );
      a(
        "TypeModeCalculPositionnementService.explication.ModeCalculNMeilleursEvals",
        "meilleures évaluations"
      );
      a(
        "TypeModeCalculPositionnementService.explication.ModeCalculPonderationAutoProgressive",
        "Positionnement calculé avec une pondération progressive automatique des niveaux de maîtrise (coeff 1 au plus ancien, puis 2, 3 ...)"
      );
      ...
      a("PageCompte.Client", "Client");
      a("PageCompte.Mobile", "Mobile");
      a("PageCompte.Navigateur", "Navigateur");
      a(
      ...
      a(
        ...
        "2. Saisissez votre nouvel identifiant :"
      );
      a(
      ...
      a(
        ...
        "3. Confirmez votre nouvel identifiant :"
      );
      a(
      ...
      a(
        ...
        "Votre enfant peut personnaliser son mot de passe à partir de l'onglet \"Mon compte\" lorsqu'il est connecté à l'Espace Elèves de l'établissement."
      );
      a(
      ...
      a("PageCompte.PratiquesAlimentaires", "Pratiques alimentaires");
      a("PageCompte.autorisationsSortie", "Autorisations de sortie");
      a("PageCompte.aJoindreJusquau", "à joindre avant le %s");
      ...
      a(
        "PageRemplacement.TotalHeuresNonAssurees",
        "Total des heures non assurées"
      );
      a(
        "PageRemplacement.TotalHeuresRemplacees",
        "Total des heures remplacées"
      );
      ...
      a(
        "RecapAbs.selectionMotifsInfirmerie",
        "Sélection des types d'intervention"
      );
      ...
      a(
        "Casier.HintColonne.AutorisationModification",
        "Modification autorisée"
      );
      a("Casier.Cmd.Maj", "Mettre à jour");
      a("Casier.Cmd.Telecharger", "Télécharger");
      a(
        "Casier.Msg.InfoSaisieRestreinte",
        "Seule la suppression des documents est autorisée"
      );
      ...
      a(
        "Casier.hintAucunMdS",
        "Aucun maître de stage n'est présent dans la base"
      );
      ...
      a(
        "MessagerieCarnetLiaison.AjouterDirecteur",
      ...
      a(
        ...
        "Tous les élèves de l'établissement sont déjà destinataires du message"
      );
      a(
      ...
      a("Messagerie.ToastArchivage", "Archivage effectue");
      ...
      a("Messagerie.QuitterModeInstantane", "Fermer le tchat");
      a(
      ...
      a(
        ...
        "Evaluation de l'entreprise par le stagiaire"
      );
