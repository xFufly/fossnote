...
a("liste.ListeFiltree", "Liste filtrée");
a("liste.DeployerReduire", "Déployer / Réduire");
a("liste.BtnAction", "Cliquer pour deployer les actions");
...
a("FenetreMentionsLegales.informationsComplementaires", "Informations complémentaires libres");
...
a("Fenetre_SelectionPublic.CumulAttendusEnCours.Detaches", "Détachés");
...
a("PageNotes.MoyenneT1", "Moy. T1");
a("PageNotes.MoyenneT2", "Moy. T2");
a("PageNotes.MoyenneT3", "Moy. T3");
a("PageNotes.MoyenneS1", "Moy. S1");
a("PageNotes.MoyenneS2", "Moy. S2");
a("PageNotes.MoyenneAbr", "Moy.");
...
a("validationMDP.RegleValide", "Règle valide");
a("validationMDP.RegleInvalide", "Règle invalide");
a("ImportExport.ChoisirFichierImport", "Choisissez le fichier à importer");
a("ImportExport.TitreFenetre", "Import de données");
a("ImportExport.AucuneDonneeDansFichierImport", "Le fichier importé ne contient pas de données");
a("ImportExport.LocalisationFichier", "Nom du fichier à importer :");
a("ImportExport.Parcourir", "Parcourir ...");
a("ImportExport.BtnImporter", "Importer");
a("ImportExport.BtnExporter", "Exporter ...");
a("ImportExport.RapportDImport", "Rapport d'import");
a("ImportExport.HintChpOlbManquant", "Le champ obligatoire %s n'est pas spécifié");
a("ImportExport.HintMauvaisGenre", "Le format de %s n'est pas celui attendu");
a("ImportExport.HintMauvaisEnumere", "La valeur doit appartenir à la liste de valeurs suivantes :\n%s");
a("ImportExport.HintMauvaisFormatDate", "Le format de date est incorrect.\nExemple correct : %s");
a("ImportExport.FormatDateUnique", "AAAA/MM/JJ");
a("ImportExport.FormatDateEurope", "JJ/MM/AAAA ou AAAA/MM/JJ");
a("ImportExport.HintLongueurMax", "La valeur \"%s\" est trop longue (%d caractères pour %d caractères maximum)");
a("ImportExport.HintLongueurMin", "La valeur \"%s\" n'est pas assez longue (%d caractères pour %d caractères minimum)");
a("ImportExport.HintNombreDouble", "La valeur \"%s\" n'est pas un nombre réel valide.");
a("ImportExport.HintNombreEntier", "La valeur \"%s\" n'est pas un nombre entier valide.");
a("ImportExport.HintValeurMax", "Elle doit être inférieure ou égale à %s.");
a("ImportExport.HintValeurMin", "Elle doit être supérieure ou égale à %s.");
a("ImportExport.LegendeChpObl", "* Au moins un de ces champs est obligatoire");
a("ImportExport.LegendeDetailNbChpOblManquant", "%d champ(s) manquant(s).");
a("ImportExport.FichierErreur", "Erreur sur la sélection du fichier");
a("ImportExport.FichierTailleIncorrect", "La taille du fichier est trop importante pour être importée");
a("ImportExport.FichierFormat", "Le fichier sélectionné ne permet pas d'importer des données. Veuillez vérifier la dispostion des données ou changez le type de fichier");
a("ImportExport.ToutVisualiser", "Visualiser toutes les données");
...
a("AppliMobile.ModeOpQrCode", "Pour générer votre QR code, définissez son code de vérification à 4 chiffres. \nIl vous sera demandé lors de la configuration de l'application mobile, sa durée de validité est de 10 minutes.");
...
a("MAJServeur.MAJ_Titre", "Mise à jour de FOSSNOTE");
a("MAJServeur.MAJ_Prevue_S", "<b>Le serveur FOSSNOTE de votre établissement sera mis à jour à %s ce qui entrainera votre déconnexion.</b><br>Cette mise à jour ne prendra que quelques minutes, vous pourrez poursuivre votre travail juste après.<br><b>Pensez à enregistrer régulièrement vos données.</b><br><br>Un second message vous préviendra quelques minutes avant la coupure.");
a("MAJServeur.MAJ_Imminente_Eleve_S", "<b>Le serveur FOSSNOTE de votre établissement sera mis à jour dans %s minutes.</b><br><b>Vous allez être déconnecté.</b><br>Cette mise à jour ne prendra que quelques minutes, vous pourrez poursuivre votre travail juste après.");
a("MAJServeur.MAJ_Imminente_S", "<b>Le serveur FOSSNOTE de votre établissement sera mis à jour dans %s minutes.</b><br><b>Enregistrez vos dernières saisies avant la déconnexion .</b><br>Cette mise à jour ne prendra que quelques minutes, vous pourrez poursuivre votre travail juste après.");
a("MAJServeur.MAJ_Annulee", "La mise à jour du serveur FOSSNOTE a été reportée.");
a("MAJServeur.MAJ_Attente", "La mise à jour du serveur FOSSNOTE de votre établissement est en cours.<br>Cette mise à jour ne prendra que quelques minutes, vous pourrez vous reconnecter juste après.");
a("MAJServeur.MAJ_Effectue", "Le serveur FOSSNOTE a été mis à jour.");
...
a("LienPolitiqueMotDePasse.UrlFAQMotDePasse", "https://www.index-education.com/redirect.php?produit=pn&page=FaqMotDePasse&version=2022.0.3.0&distrib=FR&lg=fr&flag=pointnet");
...
a("DoubleAuth.ProcedureReInitialisationCodePIN", "À l'aide du pavé numérique, saisissez le code de réinitialisation reçu par e-mail\npuis définissez un nouveau code PIN");
a("DoubleAuth.TitreReInitialisationCodePIN", "Réinitialisation du code PIN");
a("DoubleAuth.InfosSaisieReinitialisationPIN", "Saisissez le code reçu par e-mail");
a("DoubleAuth.ReinitialiserMonCodePIN", "Réinitialiser mon code PIN");
a("DoubleAuth.HintReinitialiserMonCodePIN", "Cliquez pour commencer la procédure de réinitialisation de votre code PIN");
a("DoubleAuth.EMailReinitialisationPIN_S", "Un code de réinitialisation a été envoyé à l'adresse %s.\nSaisissez-le dans la fenêtre prévue à cet effet");
...
a("DoubleAuth.EnregistrerAppareilNomInvalide", "Le nom saisi n'est pas valide");
...
a("DoubleAuth.urlTutoVideoSecurite", "https://www.index-education.com/redirect.php?produit=pn&page=securiser_son_compte&version=2022.0.3.0&distrib=FR&lg=fr&flag=SecuCL_NET");
...
a("TransformationFlux.Legende", "FOSSNOTE propose d'optimiser vos pièces jointes : compression, transformation PDF, ...");
a("TransformationFlux.PropositionCibleCloud_S", "Seul le dépôt au travers d'un cloud %s est possible");
a("TransformationFlux.FichierOriginalTransferable", "Le fichier original peut être transféré directement vers FOSSNOTE.");
...
a("QCM_Divers.CliquerPourSelectionnerReponse", "Cliquer pour sélectionner une réponse");
...
a("Legende", "Légende");
a("Fenetre_ImportFichierProf.ChoisirLeFichier", "Choisir le fichier");
a("Fenetre_ImportFichierProf.ReussiteImport", "Les données ont bien été importées ou mises à jour");
a("Fenetre_ImportFichierProf.TexteExplicatif", "Si vous avez sauvegardé vos ressources pédagogiques des années précédentes, vous pouvez les récupérer en choisissant le fichier *.zip qui les contient.");
a("Fenetre_ImportFichierProf.TexteExplicatifModelesSond", "Si vous avez sauvegardé vos modèles de sondages, vous pouvez les récupérer en choisissant le fichier *.zip qui les contient.");
a("Import.TypeDonneeAImporter", "Type de données à importer");
a("Import.ChampIgnore", "Champ ignoré");
a("Import.BaremePremiereLigne", "Barème des notes sur la première ligne importée");
...
a("Fenetre_SelectionElevesSansCours.title.UsagerTransport", "Usager des transports en commun");
...
a("SortieEleveGroupe.RetirerEleveGroupe", "Retirer l'élève du groupe");
a("SortieEleveGroupe.SurAnneeComplete", "sur l'année scolaire complète");
a("SortieEleveGroupe.EnleverUnEleveGroupe", "Enlever un élève d'un groupe");
...
a("FenetreCloud.TitreFichierCloud", "Exploration de %s");
a("FenetreCloud.NomFichierCloud", "Nom");
a("FenetreCloud.TailleFichierCloud", "Taille");
a("FenetreCloud.PartagerFichierCloud", "Partager");
a("FenetreCloud.ChoisirRepertoire_FichierCloud", "Choisir le répertoire et partager");
a("FenetreCloud.TitreFenetreFormat", "Choix du format de publication");
a("FenetreCloud.ExplicationFenetreFormat", "Vous pouvez décider de partager vos documents au format pdf. Ce format permet une consultation en lecture seule sur tout appareil sans devoir installer des applications supplémentaires.");
a("FenetreCloud.ConfirmationFenetreFormat", "Confirmez-vous le partage de vos documents dans ce format de publication ?");
a("FenetreCloud.FormatOrigine", "Format d'origine");
a("FenetreCloud.FormatPdf", "PDF");
a("FenetreCloud.FormatPublication", "Format de publication actuel");
...
a("connexion.ConnexionCAS", "Connexion à FOSSNOTE.net - Veuillez patienter...");
...
a("accueil.applicam.texteFenetre", "En t'inscrivant, tu autorises FOSSNOTE à diffuser à %s les informations suivantes :");
...
a("actualites.Edition.AvecChoixAutre", "Proposer un choix \"Autre\" pour permettre la rédaction d'un commentaire");
...
a("actualites.detailPartageSondage", "%s accède au sondage en consultation");
a("actualites.detailPartageSondageN", "%s personnes accèdent au sondage en consultation");
...
a("menus.Message.AucunMenuSurSemaine", "Aucun menu n'a été saisi pour cette semaine");
...
a("SuiviResultatsCompetences.ListeCompetencesNonMaitrisees", "Liste des compétences évaluées non maîtrisées");
a("SuiviResultatsCompetences.ListeCompetencesMaitrisees", "Liste des compétences évaluées maîtrisées");
...
a("SuiviResultatsCompetences.colonnes.NbCompetencesSucces", "Compétences maîtrisées");
a("SuiviResultatsCompetences.colonnes.NbCompetencesEchecs", "Compétences non maîtrisées");
a("SuiviResultatsCompetences.hintColonnes.NbCompetencesSucces", "Nombre de compétences maîtrisées");
a("SuiviResultatsCompetences.hintColonnes.NbCompetencesEchecs", "Nombre de compétences non maîtrisées");
a("SuiviResultatsCompetences.fenetreOptionsAff.Titre", "Paramètres d'affichage");
a("SuiviResultatsCompetences.fenetreOptionsAff.CompetencesNonMaitrisees", "Compétences non maîtrisées");
a("SuiviResultatsCompetences.fenetreOptionsAff.CompetencesMaitrisees", "Compétences maîtrisées");
a("SuiviResultatsCompetences.fenetreOptionsAff.EchecCompetenceSi", "Une compétence est considérée comme non maîtrisée si :");
a("SuiviResultatsCompetences.fenetreOptionsAff.SuccesCompetenceSi", "Une compétence est considérée comme maîtrisée si :");
a("SuiviResultatsCompetences.fenetreOptionsAff.AuMoins", "au moins");
a("SuiviResultatsCompetences.fenetreOptionsAff.PourcentageEvalsCompEvaluees", "% des évaluations ont le niveau %s");
a("SuiviResultatsCompetences.fenetreOptionsAff.ElementsUtilisesDansCalcul", "Élément des grilles de compétence utilisé dans le calcul des taux");
a("SuiviResultatsCompetences.fenetreOptionsAff.CalculParElementsSignifiants", "Élément signifiant");
a("SuiviResultatsCompetences.fenetreOptionsAff.CalculParCompetences", "Compétence");
...
a("evaluations.FenetreSaisieEvaluation.DecalageUnJourPublicationParentsSoitLe", "Conformément au choix de l'établissement, l'évaluation sera publiée aux parents un jour après la publication aux élèves, soit le %s");
a("evaluations.FenetreSaisieEvaluation.DecalageXJoursPublicationParentsSoitLe", "Conformément au choix de l'établissement, l'évaluation sera publiée aux parents %d jours après la publication aux élèves, soit le %s");
...
a("TypeModeAssociationDevoirEvaluation.CreerUnDevoir", "Créer un devoir");
a("TypeModeAssociationDevoirEvaluation.ModifierLeDevoir", "Modifier le devoir");
a("TypeModeAssociationDevoirEvaluation.SupprimerLeDevoir", "Supprimer le devoir");
a("TypeModeAssociationDevoirEvaluation.SupprimerLeLienDevoirEvaluation", "Supprimer le lien entre l'évaluation et le devoir");
...
a("releve_evaluations.parametres.DetailSimu1", "Mode 1 - Positionnement calculé à partir des niveaux de maîtrise affichés");
a("releve_evaluations.parametres.DetailSimu2", "Mode 2 - Positionnement calculé à partir des");
a("releve_evaluations.parametres.DetailSimu3", "Mode 3 - Positionnement calculé à partir des");
a("releve_evaluations.parametres.DetailSimu4", "Mode 4 - Positionnement calculé avec une pondération progressive automatique des niveaux de maîtrise (coeff 1 au plus ancien, puis 2, 3 ...)");
a("releve_evaluations.parametres.DetailSimu2Suite", "dernières évaluations");
a("releve_evaluations.parametres.DetailSimu3Suite", "meilleures évaluations");
...
a("FicheStage.listeSuivis.etatPublication", "Publier sur les Espaces Parents et Elèves");
a("FicheStage.listeSuivis.hintPublication", "Publiée sur les Espaces parents et élèves");
...
a("iCal.fenetre.titreFichier", "Cliquez sur le lien ci-dessous pour télécharger le fichier iCal  de l'emploi du temps tel qu'il est actuellement (il ne sera pas mis à jour automatiquement)");
a("iCal.fenetre.titreFichier", "Cliquez sur le lien ci-dessous pour télécharger le fichier iCal  de l'agenda tel qu'il est actuellement (il ne sera pas mis à jour automatiquement)");
...
a("iCal.fenetre.titreLienPermanent", "Copiez l'adresse ci-dessous dans votre \"gestionnaire d'agenda\" pour le synchroniser avec FOSSNOTE (votre emploi du temps sera mis à jour en temps réel)");
a("iCal.fenetre.titreLienPermanent", "Copiez l'adresse ci-dessous dans votre \"gestionnaire d'agenda\" pour le synchroniser avec FOSSNOTE (votre agenda sera mis à jour en temps réel)");
...
a("ficheScolaire.pfmp.libelleDuree", "Durée de la période des stages en semaines");
a("ficheScolaire.pfmp.libelleEtranger", "PFMP effectué en partie à l'étranger");
a("ficheScolaire.pfmp.exportAppreciationsReferents", "Exporter les appréciations de stage des professeurs référents");
...
a("ficheScolaire.pfmp.appreciations", "Appréciations des professeurs référents");
...
a("dossierVieScolaire.listeTitres", "");
a("dossierVieScolaire.listeTitres", "Pub.");
...
a("dossierVieScolaire.fenetre.infoEditionCategorie", "Édition des catégories");
...
a("fenetreSelectionClasseGroupe.titreGroupes", "Sélection des groupes");
...
a("incidents.declaration", "Déclaration d'incident du %s");
a("incidents.uniquementMesIncidents", "Uniquement les incidents que j'ai signalés");
a("incidents.uniquementNonRA", "Uniquement les incidents non réglés");
a("incidents.selectionnez", "Sélectionnez un incident");
a("incidents.IncidentDu", "Incident du %s");
a("incidents.professeur", "Professeur");
a("incidents.personnel", "Personnel");
a("incidents.signalement.titre", "Signalement d'un incident");
a("incidents.date", "Date");
a("incidents.heure", "Heure");
a("incidents.motifs", "Motifs");
a("incidents.lieu", "Lieu");
a("incidents.details", "Détails");
a("incidents.auteurs", "Auteur(s) de l'incident");
a("incidents.victimes", "Victime(s)");
a("incidents.temoins", "Témoin(s)");
a("incidents.vise", "Visé");
a("incidents.regle", "RA");
a("incidents.creation", "Signaler un nouvel incident");
a("incidents.accompagnateur", "Accompagnateur");
a("incidents.faitDeViolence", "Fait de violence");
a("incidents.actionsEnvisagees", "Actions envisagées");
a("incidents.hintActionsEnvisagees", "Actions immédiates menées par l'établissement");
a("incidents.protagonistes.titre", "Personnes impliquées");
a("incidents.protagonistes.identite", "Identité");
a("incidents.protagonistes.implication", "Implication");
a("incidents.protagonistes.mesures", "Mesure disciplinaire");
a("incidents.protagonistes.date", "Date");
a("incidents.protagonistes.pubDossier", "Publier le dossier lié à l'incident dans les dossiers de la vie scolaire sur l'Espace parents");
a("incidents.protagonistes.publier", "Publier l'incident dans le récapitulatif de la vie scolaire sur l'Espace parents");
a("incidents.protagonistes.ajouter", "Ajouter un protagoniste");
a("incidents.protagonistes.existent", "Le(s) protagoniste(s) suivants existe(nt) dèjà :");
a("incidents.protagonistes.vuLe", "Vu le");
a("incidents.circonstances", "Circonstances");
a("incidents.auteurDuSignalement", "Auteur du signalement");
a("incidents.gravite", "Gravité");
a("incidents.actions", "Actions immédiates menées par l'établissement");
a("incidents.commentaire", "Commentaire");
a("incidents.diffuserInfoTitre", "Diffuser l'information dans l'établissement");
a("incidents.diffuserEquipesPedagogiques", "Informer les équipes pédagogiques et les CPE");
a("incidents.messageEnvoye", "Message envoyé");
a("incidents.selectLieux", "Salle ou lieu");
a("incidents.selectMesuresDisciplinaire", "Sélectionner une mesure disciplinaire");
...
a("punition.hint.Publication", "Double clic pour publier la punition dans le récapitulatif de la vie scolaire sur l'Espace Parents");
...
a("punition.informerEquipePedagogique", "Informer l'équipe pédagogique de l'élève et les CPE");
a("punition.messageEnvoye", "Message envoyé");
a("punition.publierPunition", "Publier la punition dans le récapitulatif de la vie scolaire sur l'Espace Parents");
...
a("fenetreCommunication.bouton.fenetreCommunication", "Communications (Ancienne méthode)");
a("fenetreCommunication.bouton.fenetreCloud", "Envoyer le fichier vers un cloud");
a("fenetreCommunication.bouton.fenetreGenerationPDF", "Générer le PDF dans un nouvel onglet");
...
a("infosperso.AppliquerThemeAccessible", "Passer les interfaces en niveaux de gris");
...
a("infosperso.infosAllergiesConsultables", "J'autorise leur diffusion au reste du personnel (administratif et enseignants)");
...
a("infosperso.messageSignature", "Cette signature sera apposée sur les bilans périodiques (si l'option est choisie par votre Directeur)");
...
a("progression.AffecterAuxCours", "Affecter aux cours");
...
a("progression.creer", "Créer une Préparation");
a("progression.importer", "Importer");
a("progression.msgAucune", "Créez une Préparation puis ajoutez vos fiches");
a("progression.msgAucuneProg", "Sélectionnez une matière pour créer des fiches de préparation liées à cette matière.");
a("progression.msgAucunContenu", "Créer une nouvelle fiche pour commencer la préparation");
a("progression.titreProgression", "Titre de la progression");
a("progression.creerContenu", "Nouvelle fiche");
a("progression.hintNouvelleFiche", "Ajouter une fiche à ma préparation");
a("progression.progression", "Progression");
a("progression.titreFiche", "Titre de la fiche");
a("progression.modalites", "Modalité pédagogique");
a("progression.objectif", "Objectif de la séance");
a("progression.obj", "Objectif");
a("progression.description", "Description");
a("progression.eltProgramme", "Eléments de programme");
a("progression.ressPeda", "Ressources pédagogiques");
a("progression.editerFiche", "Modifier la fiche");
a("progression.editerFichePrep", "Modifier la fiche de préparation");
a("progression.dupliquerFiche", "Dupliquer");
a("progression.msgConfirmSupprFiche", "Confirmez-vous la suppression de cette fiche ?");
a("progression.cible", "Progression cible");
a("progression.dupliquerContenu", "Dupliquer la séance %s");
a("progression.infoDupliquer", "La nouvelle séance sera placée à la fin de la progression cible.");
a("progression.modifierProgression", "Modifier la Préparation");
a("progression.msgConfirmSupprProgression", "Confirmez-vous la suppression de la progression ?");
...
a("CahierDeTexte.TAFARendre.EnregistrementADeposer", "Audio - A enregistrer sur l'Espace Elèves ( 3 min. max)");
...
a("FenetreListeTAFFaits.FenetreProlongationRendu.Message", "L'élève pourra déposer sa copie jusqu'au");
...
a("TypeDispenseEleveDeCours.enseignementALaMaison", "enseignement à la maison");
a("TypeDispenseEleveDeCours.enStage", "en stage");
a("TypeDispenseEleveDeCours.dispense", "dispensé");
a("TypeDispenseEleveDeCours.dispensePresence", "dispensé présence obligatoire");
...
a("AbsenceVS.absenceEnAttente", "En attente d'acceptation par la vie scolaire");
...
a("AbsenceVS.msgSuppressionValorisation", "Confirmez-vous la suppression de cette valorisation ?");
...
a("SuivisAR.Selectionner", "Sélectionner");
...
a("SuivisAR.remplacerCertificat", "Remplacer le certificat médical");
a("SuivisAR.supprimerCertificat", "Supprimer le certificat médical");
a("SuivisAR.consulterCertificat", "Consulter le certificat médical");
...
a("FicheEleve.nonConsultable", "N'est pas consultable par l'équipe pédagogique");
...
a("FicheEleve.UniquementMetaMatiere", "Uniquement les aménagements communs et liés à ma discipline");
...
a("Fenetre_SaisieAgenda.Titre", "Titre");
a("Fenetre_SaisieAgenda.SansHoraire", "Sans horaire");
a("Fenetre_SaisieAgenda.PublicConcerne", "Public concerné");
a("Fenetre_SaisieAgenda.ClassesGroupes", "Classes/Groupes");
a("Fenetre_SaisieAgenda.AucuneClasseGroupe", "Aucun(e) classe/groupe");
a("Fenetre_SaisieAgenda.AucunProfesseur", "Aucun professeur");
a("Fenetre_SaisieAgenda.Publie", "Partagé avec *");
a("Fenetre_SaisieAgenda.Partage", "Partagé");
a("Fenetre_SaisieAgenda.NonPartage", "Non partagé");
...
a("Fenetre_SaisieAgenda.Debut", "Début");
a("Fenetre_SaisieAgenda.Fin", "Fin");
a("Fenetre_SaisieAgenda.FamilleEvenement", "Catégorie :");
...
a("Fenetre_SaisieAgenda.FenetrePeriodiciteDe", "De");
a("Fenetre_SaisieAgenda.FenetrePeriodiciteA", "à");
...
a("Fenetre_SaisieAgenda.FenetrePeriodiciteMensuelle", "Mensuelle");
...
a("Fenetre_SaisieAgenda.FenetrePeriodiciteTousLesMin", "tous les");
...
a("Orientation.Orientation", "Orientation");
a("Orientation.SpecialitesOrdre", "Enseignements de spécialité par ordre de préférence");
a("Orientation.Option", "Option(s)");
a("Orientation.PublieLe", "Sera publiée le %s");
a("Orientation.Ressources.LettreEtablissement", "E");
a("Orientation.Ressources.LettreHorsEtablissement", "HE");
a("Orientation.Ressources.DispoEtablissement", "Proposées par l'établissement");
a("Orientation.Ressources.DispoHorsEtablissement", "Uniquement hors de l'établissement");
a("Orientation.Ressources.AvisProvisoireCC", "Avis provisoires du conseil de classe");
a("Orientation.Ressources.MsgAvisProvisoireCC", "L'avis provisoire du conseil de classe sera disponible à partir du %s");
a("Orientation.Ressources.IntentionsFamille", "Intentions d'orientation de la famille");
a("Orientation.Ressources.RecommandationSurVoieNonDemandee", "Recommandation sur une voie non demandée");
a("Orientation.Ressources.PropositionCC", "Proposition du conseil de classe");
a("Orientation.Ressources.MsgPropositionCC", "La proposition du conseil de classe sera disponible à partir du %s");
a("Orientation.Ressources.PropositionSurVoieNonDemandee", "Proposition sur une voie non demandée");
a("Orientation.Ressources.DecisionRetenue", "Décision retenue");
a("Orientation.Ressources.MsgDecisionRetenue", "La décision du conseil de classe sera disponible à partir du %s");
a("Orientation.Ressources.Commentaire", "Commentaire");
a("Orientation.Ressources.IntentionsOrientations", "Intentions d'orientation");
a("Orientation.Ressources.ChoixDefinitifs", "Choix Définitifs");
a("Orientation.Bouton.Supprimer", "Supprimer la sélection");
a("Orientation.Ressources.MessageSaisieIndisponible", "Les demandes des familles pourront être saisies à partir du %s");
a("Orientation.TitreListe", "Choix de l'orientation");
a("Orientation.ClicChoixOrientation", "Cliquez ici pour choisir une orientation");
a("Orientation.Supprimer", "Voulez-vous supprimer l'orientation ?");
a("Orientation.Specialites.TitreListe", "Choix des enseignements de spécialité");
a("Orientation.Specialites.ClicChoixSpecialite", "Cliquez ici pour choisir une spécialité");
a("Orientation.Specialites.Supprimer", "Voulez-vous supprimer la spécialité ?");
a("Orientation.Specialites.UniquementSpecialiteEleve", "Uniquement les spécialités de l'élève");
a("Orientation.Options.TitreListe", "Choix des options");
a("Orientation.Options.ClicChoixOption", "Cliquez ici pour choisir une option");
a("Orientation.Options.Ajouter", "Ajouter une option");
a("Orientation.Options.Supprimer", "Voulez-vous supprimer l'option ?");
a("Orientation.Options.AjoutImpossible", "Ajout impossible. Vous avez atteint le nombre maximal d'options");
a("Orientation.Options.AucuneOptionDisponible", "Toutes les options disponibles ont été sélectionnées");
a("Orientation.Bouton.IntentionsOrientation", "Valider les intentions d'orientation");
a("Orientation.Bouton.ChoixDefinitifs", "Valider les choix définitifs");
a("Orientation.SaisiePriseEnCompte", "Votre saisie a bien été prise en compte");
a("Orientation.AR.AvisProvisoireAValider", "Avis provisoire du conseil de classe à valider avant le %s");
a("Orientation.AR.AvisProvisoireValide", "Avis provisoire du conseil de classe validé");
a("Orientation.AR.ChoixDOrientationAValider", "Choix définitif d'orientation à valider avant le %s");
a("Orientation.AR.ChoixDOrientationValide", "Choix définitif d'orientation validé");
a("Orientation.AR.PropositionCCStageAR", "Proposition du conseil de classe sur le(s) stage(s) passerelle(s)");
a("Orientation.AR.PrisConnaissance", "J'ai pris connaissance de l'avis du conseil de classe");
a("Orientation.AR.FamillePrisConnaissance", "La famille a pris connaissance de l'avis du conseil de classe");
a("Orientation.AR.Jaccepte", "J'accepte");
a("Orientation.AR.JeRefuse", "Je refuse");
a("Orientation.AR.LaFamilleAccepteLaPropositionDuConseilDeClasse", "La famille accepte la proposition du conseil de classe");
a("Orientation.AR.LaFamilleNAcceptePasLaPropositionEtDemandeUnRDV", "La famille n'accepte pas la proposition et demande un rendez-vous");
a("Orientation.AR.NousAcceptons", "Nous acceptons");
a("Orientation.AR.NousAcceptonsSuite", "la proposition du conseil de classe suivante :");
a("Orientation.AR.MsgARProposition", "Celle-ci devient la décision d'orientation définitive prise par le chef d'établissement.<br>Nous avons pris connaissance des recommandations du conseil de classe.");
a("Orientation.AR.NousAcceptonsAucune", "Nous n'acceptons aucune");
a("Orientation.AR.NousAcceptonsAucuneSuite", "des propositions du conseil de classe et prenons immédiatement contact avec le chef d'établissement.");
a("Orientation.AR.MsgAttentionSaisieAR", "Attention, vous avez jusqu'au %s pour donner votre réponse sur la proposition du conseil de classe.");
a("Orientation.MsgAucuneOrientation", "Aucune information n'a été renseignée. La période de saisie est clôturée");
a("Orientation.AucuneOrientation", "Aucune orientation n'a été renseignée.");
...
a("CarnetCorrespondance.DefautCarnet", "Défauts de carnet");
a("CarnetCorrespondance.ObservationsParents", "Observations");
a("CarnetCorrespondance.AutresEvenements", "Autres évènements signalés dans les feuilles d'appel");
a("CarnetCorrespondance.Vue", "Vue le");
a("CarnetCorrespondance.LueLe", "Lue le");
a("CarnetCorrespondance.Redacteur", "Saisie par");
a("CarnetCorrespondance.Observation", "Observation");
a("CarnetCorrespondance.Encouragement", "Encouragement");
...
a("CarnetCorrespondance.NouvelEncouragement", "Saisir un nouvel encouragement");
a("CarnetCorrespondance.NouveauDefautCarnet", "Saisir un nouveau défaut de carnet");
a("CarnetCorrespondance.TypeDObservation", "Type d'observation");
a("CarnetCorrespondance.MatiereEtProfesseur", "Matière et professeur");
a("CarnetCorrespondance.Commentaire", "Commentaire");
a("CarnetCorrespondance.Publie", "Publié");
a("CarnetCorrespondance.Vu", "Vu le");
...
a("Observations.Encouragements", "Encouragements");
...
a("TvxIntendance.Widget.MaintenanceInfo.Titre", "Maintenance Informatique");
a("TvxIntendance.Widget.MaintenanceInfo.TitreToutesDemandes", "Maintenance Informatique");
...
a("TvxIntendance.ConfirmationTransferer", "Voulez-vous vraiment transférer la tâche sélectionée de \"%s\" vers \"%s\"");
a("TvxIntendance.TransfererVers", "Tranférer la sélection vers \"%s\"");
a("TvxIntendance.Type.MaintenanceInformatique", "Maintenance informatique");
...
a("FenetreDevoir.DetailNotesNonPublie", "Les notes de ce service ne sont pas publiées sur les Espaces Elève et Parent");
a("FenetreDevoir.DecalageUnJourPublicationParentsSoitLe", "Conformément au choix de l'établissement, la note sera publiée aux parents un jour après la publication aux élèves, soit le %s");
a("FenetreDevoir.DecalageXJoursPublicationParentsSoitLe", "Conformément au choix de l'établissement, la note sera publiée aux parents %d jours après la publication aux élèves, soit le %s");
...
a("FenetrePanierKiosque.info.TAF", "Seules les ressources disposant de l'icône des exercices numériques %s dans le contenu du manuel numérique peuvent être associées à un travail à faire dans FOSSNOTE.");
a("FenetrePanierKiosque.info.iDevoir", "Seules les ressources disposant de l'icône iDevoir %s dans le contenu du manuel numérique peuvent être associées à un devoir dans FOSSNOTE.");
...
a("FenetrePanierKiosque.infoAjoutRessourcesGranulaires", "Sélectionnez le manuel puis sélectionnez votre ressource parmi celles que vous avez déjà extraites.\nSi elle n'est présente pas dans la liste, cliquez sur \"Ajouter une ressource\". Dans le manuel, récupérez les ressources de votre choix en cliquant sur le bouton %s parmi les ressources exploitables dans FOSSNOTE.");
...
a("FenetrePanierKiosque.creerL.text3", "3. Envoyez le lien de la ressource vers FOSSNOTE.");
a("FenetrePanierKiosque.creerL.text4", "4. Depuis FOSSNOTE, sélectionnez et ajoutez le lien depuis l'affichage de saisie du cahier de textes : ajouter le lien à un contenu ou en documents joints dans un travail à faire.");
...
a("FenetrePanierKiosque.creerT.text3", "3. Envoyez le lien de la ressource vers FOSSNOTE.");
a("FenetrePanierKiosque.creerT.text4", "4. Depuis FOSSNOTE, sélectionnez et ajoutez le lien depuis l'affichage de saisie d'un travail à faire : %s");
a("FenetrePanierKiosque.creerT.text4b", "ajouter un exercice numérique en associant un lien à un travail à faire, l'élève y répondra directement sur le site de l'éditeur et vous récupérerez automatiquement ses réponses dans FOSSNOTE.");
...
a("FenetrePanierKiosque.creerD.text3", "3. Envoyez le lien de la ressource vers FOSSNOTE.");
a("FenetrePanierKiosque.creerD.text4", "4. Depuis FOSSNOTE, sélectionnez et ajoutez le lien depuis l'affichage de saisie des notes : %s");
a("FenetrePanierKiosque.creerD.text4b", "ajouter un iDevoir en associant un lien à un devoir, l'élève y répondra directement sur le site de l'éditeur et vous récupérerez automatiquement ses réponses et sa note dans FOSSNOTE.");
...
a("FenetreParamExecutionQCM.FenetrePersonnalisation.titreSelectionEleves", "Elèves");
...
a("RecapitulatifExportLSU.Afficher_uniquement_eleves_non_exportables", "Afficher uniquement les élèves non exportables");
a("RecapitulatifExportLSU.VoirLivretEleve", "Voir le livret de l'élève");
a("RecapitulatifExportLSU.SaisieEnseignementsComplement", "Enseignement de complément");
a("RecapitulatifExportLSU.SaisieObjectifs", "Points d'enseignement de complément");
a("RecapitulatifExportLSU.SaisieLangueRegionale", "Langue régionale");
a("RecapitulatifExportLSU.SaisieNiveauLangueRegionale", "Niveau en langue régionale");
a("RecapitulatifExportLSU.ExporterVersLSU", "Exporter vers LSU");
a("RecapitulatifExportLSU.DescriptifExportLSU", "Cet export génère le fichier pour l'application LSU (Livret Scolaire Unique).");
a("RecapitulatifExportLSU.InclureBilanFinDeCycle", "Inclure les bilans de fin de cycle pour %s");
a("RecapitulatifExportLSU.ClassesFinDeCycleSecondaire", "les 3ème et les 6ème");
a("RecapitulatifExportLSU.ClassesFinDeCyclePrimaire", "les CE2");
a("RecapitulatifExportLSU.ExportDonneesDeLaPeriode", "Vous avez choisi d'exporter les données de la période %s.");
a("RecapitulatifExportLSU.PeriodeDefinieDuAu", "Dans FOSSNOTE, cette période est définie du %s au %s.");
a("RecapitulatifExportLSU.VerificationDatesSurONDE", "Vérifier bien que les dates saisies dans LSU pour cette période sont identiques.");
...
a("TypeModeCalculPositionnementService.explication.PosCalculeAPartirDe", "Positionnement calculé à partir des");
a("TypeModeCalculPositionnementService.explication.ModeCalculNDernieresEvals", "dernières évaluations");
a("TypeModeCalculPositionnementService.explication.ModeCalculNMeilleursEvals", "meilleures évaluations");
...
a("Rencontres.planningDeLaSession", "Planning de la session %s");
a("Rencontres.InfoIndisponibilitesAutreResponsables", "Au moins un autre responsable est indisponible");
...
a("Rencontres.lienVisio", "Lien Visio");
...
a("InstallPronote.titre", "Installation de FOSSNOTE Client");
a("InstallPronote.Installer", "Installez le Client FOSSNOTE");
...
a("Messagerie.HintQuitterModeInstantane", "Les messages de ce tchat apparaîtront dans vos discussions. Vous pourrez les isoler à nouveau depuis l'affichage des discussions");
...
a("PrefMess.UniquementLesMessagesDesParentsEtEleves", "uniquement les messages des responsables et des élèves");
...
a("PrefMess.ActiverMessageAutoCourt", "Activer le retour automatique");
...
a("ListeRessources.DateNaissance", "Date de naissance");
...
a("ListeRessources.ElevesTutores", "Elèves tutorés");
a("ListeRessources.HintElevesTutores", "Elève dont le professeur est tuteur");
a("ListeRessources.HistoriqueChangements", "Historique des changements");
a("ListeRessources.PersonnelAccompagnant", "Ce personnel est un accompagnant");
...
a("grilleAbsence.typeSaisie", "Type de saisie");
...
a("grilleAbsence.HintSaisieCarnetOublieJournee", "Saisir un défaut de carnet");
a("grilleAbsence.HintEnleverCarnetOublieJournee", "Enlever un défaut de carnet");
...
a("grilleAbsence.hintInternat.absence", "Absence internat");
...
a("grilleAbsence.liste.hint.Certificat", "Certificat médical");
a("grilleAbsence.liste.SemaineDuAu", "Semaine du %s au %s");
a("grilleAbsence.liste.Oui", "Oui");
a("grilleAbsence.liste.Non", "Non");
a("grilleAbsence.menu.certificat", "Certificat médical");
a("grilleAbsence.menu.consulter", "Consulter");
a("grilleAbsence.menu.supprimer", "Supprimer");
a("competencesGrilles.GrilleCompetences.ClassesEvaluees", "Classes évaluées");
a("competencesGrilles.GrilleCompetences.ClassesEvalueesToutes", "Classes évaluées (Toutes)");
...
a("competencesGrilles.GrilleCompetences.AjouterGrille", "Ajouter un référentiel");
...
a("competencesGrilles.ListeCompetences.HintNiveaux", "Niveaux pour lesquels la compétence est évaluée");
...
a("competencesGrilles.ListeCompetences.InfoUtiliteNiveauCompNumeriques", "La saisie d'un niveau (sur une échelle de 1 à 8) est nécessaire pour positionner les élèves sur chaque compétence numérique.");
...
a("competencesGrilles.ListeCompetences.FenetreChoixNiveaux.Titre", "Liste des niveaux");
...
a("blog.uniquAModerer", "Uniquement à modérer");
...
a("blog.billet.categorie", "Ajouter une catégorie");
a("blog.billet.typeDiff_Classe", "pour la classe");
a("blog.billet.typeDiff_Ecole", "pour l'école");
a("blog.billet.Classe", "Classe");
a("blog.billet.Ecole", "Ecole");
a("blog.billet.brouillon", "Brouillon");
...
a("blog.newCategorie", "Nouvelle catégorie");
...
a("blog.aucuneDonneeDansMediatheque", "Ajouter un document ou une catégorie à la médiathèque");
a("blog.filtre.sansCategorie", "Non classé");
a("blog.creerCategorieMediatheque", "Créer une nouvelle catégorie");
a("blog.editerCategorieMediatheque", "Editer la catégorie");
a("blog.creer", "Créer");
a("blog.renommer", "Renommer");
a("blog.msgConfirmSupprCategorieMediatheque", "Confirmez-vous la suppression de la catégorie ?");
...
a("blog.categoriesMediatheque", "Catégories de la médiathèque");
...
a("blog.derniersBilletsPublies", "Derniers billets du blog");
a("blog.aucunBilletPublie", "Aucun billet publié");
a("blog.filActuBlog", "Fil d'actualité du blog");
a("blog.redigePar", "Rédigé par");
a("blog.contenuFiltrePar", "Contenu filtré par : %s");
a("blog.redacteursN", "%s rédacteurs");
a("blog.tousLesRedacteursN", "Tous les rédacteurs (%s)");
a("blog.aucunCommentaire", "Aucun commentaire");
a("cloudIndex.utilisationCloud", "Utilisation du Cloud FOSSNOTE");
a("cloudIndex.creationCompte", "Je crée mon compte sur le Cloud FOSSNOTE");
a("cloudIndex.associationCompte", "J'associe mon compte Cloud FOSSNOTE à cet établissement");
a("cloudIndex.pasEncoreCompte", "Je n'ai pas encore de compte");
a("cloudIndex.dejaCompte", "J'ai déjà un compte sur le Cloud FOSSNOTE");
a("cloudIndex.explication", "Le Cloud FOSSNOTE est proposé à tous les enseignants travaillant dans un des établissements pilotes hébergés chez Index Education.<br/>Il vous permet :<ul><li>de stocker vos documents à usage pédagogique</li><li>d'y accéder à partir de tout poste de travail, tablette et smartphone depuis chez vous ou depuis votre établissement</li><li>de mettre à disposition des autres enseignants les documents de votre choix</li><li>d'accéder à un référentiel mutualisé de ressources pédagogiques</li></ul><br/><b>Pour l'utiliser, vous devez disposer d'un compte personnel sur le cloud FOSSNOTE et l'associer aux établissements dans lesquels vous enseignez</b>");
...
a("FenetreCategorieEvaluation.editionCategorie", "Edition de la catégorie");
...
a("Theme.filtrePar.mesMatieres", "Uniquement les thèmes associés à mes matières.");
a("Theme.libelleCB.taf", "Uniquement les thèmes associés aux matières du travail à faire");
a("Theme.libelleCB.contenu", "Uniquement les thèmes associés aux matières du contenu");
a("Theme.libelleCB.devoir", "Uniquement les thèmes associés aux matières du devoir");
a("Theme.libelleCB.qcm", "Uniquement les thèmes associés aux matières du QCM");
a("Theme.libelleCB.evaluation", "Uniquement les thèmes associés aux matières de l'évaluation");
a("Theme.libelleCB.selection", "Uniquement les thèmes associés aux matières de la sélection");
a("Theme.libelleCB.forum", "Uniquement les thèmes associés aux matières du sujet de forum");
a("Theme.libelleCB.ressource", "Uniquement les thèmes associés aux matières de la ressource pédagogique");
...
a("Attestation.delivreeLe", "Délivrée le");
...
a("ForumPeda.MenuAction_SignalerSPR", "Signaler au superviseur");
...
a("ForumPeda.ConfirmationSignalementSPR", "Êtes-vous sûr de vouloir signaler ce post au SPR ?");
...
a("ForumPeda.VisiteurSPR", "Forum visible par le chef d'établissement");
