...
a("Onglet.Libelle", "Permanences et personnels - Appel et suivi");
a("Onglet.Libelle", "Permanences et personnels - Appel");
a("Onglet.Libelle", "");
a("Onglet.Libelle", "");
a("Onglet.Libelle", "");
...
a("SuiviJustificationAbsRet.NomEleve", "Nom");
a("SuiviJustificationAbsRet.Classe", "Classe");
a("SuiviJustificationAbsRet.Regime", "Régime");
a("SuiviJustificationAbsRet.DureeRetard", "Durée");
a("SuiviJustificationAbsRet.HintDureeRetard", "Durée du retard ou du passage à l'infirmerie");
a("SuiviJustificationAbsRet.Date", "Date");
a("SuiviJustificationAbsRet.Motif", "Motif");
a("SuiviJustificationAbsRet.JustificationParents", "Justification donnée par les parents");
a("SuiviJustificationAbsRet.RaisonDonneeParents", "Raison donnée par les parents");
a("SuiviJustificationAbsRet.CommentaireParents", "Commentaire");
a("SuiviJustificationAbsRet.HintCommentaireParents", "Commentaire saisi depuis l'Espace Parents");
a("SuiviJustificationAbsRet.DateJustificationParents", "Date");
a("SuiviJustificationAbsRet.HintDateJustificationParents", "Date de justification dans l'Espace Parents");
a("SuiviJustificationAbsRet.AcceptationEtablissement", "Acceptée");
a("SuiviJustificationAbsRet.DureeAbsenceCours", "Heures Cours");
a("SuiviJustificationAbsRet.HintDureeAbsenceCours", "Nombre d'heures de cours manquées");
a("SuiviJustificationAbsRet.MatieresAffectees", "Matière");
a("SuiviJustificationAbsRet.EstOuvert", "Ouverte");
a("SuiviJustificationAbsRet.HintEstOuvert", "Absence ouverte");
a("SuiviJustificationAbsRet.DemiJourneesBulletin", "1/2j. Bul.");
a("SuiviJustificationAbsRet.HintDemiJourneesBulletin", "Nombre de demi-journées bulletin d'absence");
a("SuiviJustificationAbsRet.Justifie", "Justifiée");
a("SuiviJustificationAbsRet.RegleAdministrativement", "RA");
a("SuiviJustificationAbsRet.HintRegleAdministrativement", "Réglée administrativement");
a("SuiviJustificationAbsRet.Suivi", "Suivi");
a("SuiviJustificationAbsRet.FiltreNonRA", "Uniquement les non reglés administrativement");
a("SuiviJustificationAbsRet.Oui", "Oui");
a("SuiviJustificationAbsRet.Non", "Non");
a("SuiviJustificationAbsRet.JustificationAcceptee", "ACCEPTÉE");
a("SuiviJustificationAbsRet.HintAbsenceOuverte", "Absence ouverte");
a("SuiviJustificationAbsRet.PieceJointeConsulter", "Consulter");
a("SuiviJustificationAbsRet.PieceJointeRemplacer", "Remplacer");
a("SuiviJustificationAbsRet.PieceJointeSupprimer", "Supprimer");
a("SuiviJustificationAbsRet.ConfirmationEcrasementMotif", "Un motif est déjà rempli et va être écrasé. Confirmez-vous ?");
