...
a("Onglet.Libelle", "Bulletin de l'élève");
a("Onglet.Libelle", "");
...
a("Onglet.Libelle", "Bilan périodique de l'élève");
...
a("Onglet.LibelleLong", "Equipe pédagogique de mon enfant");
a("Onglet.LibelleLong", "");
a("Onglet.LibelleLong", "");
a("Onglet.LibelleLong", "");
a("Onglet.LibelleLong", "");
...
a("InfosMedicales.AllergiesRepertoriees", "Allergies répertoriées");
a("InfosMedicales.SaisieAllergiesRepertoriees", "Saisie des allergies répertoriées");
a("InfosMedicales.TitreAllergiesAlimentaires", "Allergies alimentaires");
a("InfosMedicales.TitreAllergiesAutres", "Autres allergies");
a("InfosMedicales.Restrictions", "Alimentation");
a("InfosMedicales.SaisieRestrictions", "Saisie des pratiques alimentaires");
a("InfosMedicales.AjouterAllergie", "Ajouter/Supprimer une allergie");
a("InfosMedicales.AjouterRestriction", "Ajouter/Supprimer un régime alimentaire");
...
a("DernieresNotes.NoteRameneeSur", "Note ramenée sur %d");
a("DernieresNotes.DevBonus", "Devoir facultatif (seuls les points supérieur à la moyenne sont comptabilisés)");
a("DernieresNotes.DevFacultatif", "Devoir facultatif (note prise en compte que si elle augmente la moyenne)");
a("DernieresNotes.DetailsMethodeCalcMoy", "Détails du calcul de la moyenne");
...
a("incriptionsEtablissement.formulaireCourt", "Formulaire de pré-inscription");
a("incriptionsEtablissement.avecCompte", "Vous avez déjà un compte FOSSNOTE dans cet établissement ?");
a("incriptionsEtablissement.sansCompte", "Vous n'avez pas de compte FOSSNOTE dans cet établissement ?");
a("incriptionsEtablissement.identiteResponsable", "Identité du responsable");
a("incriptionsEtablissement.civilite", "Civilité");
a("incriptionsEtablissement.nom", "Nom");
a("incriptionsEtablissement.prenom", "Prénom");
a("incriptionsEtablissement.adresse", "Adresse");
a("incriptionsEtablissement.complementAdresse", "Complément d'adresse");
a("incriptionsEtablissement.ville", "Ville");
a("incriptionsEtablissement.CPVille", "Code postal");
a("incriptionsEtablissement.pays", "Pays");
a("incriptionsEtablissement.telephone", "Téléphone");
a("incriptionsEtablissement.telephoneMobile", "Téléphone mobile");
a("incriptionsEtablissement.fratrieTitre", "Fratrie actuellement présente dans l'établissement (%d)");
a("incriptionsEtablissement.classe", "Classe");
a("incriptionsEtablissement.oui", "Oui");
a("incriptionsEtablissement.non", "Non");
a("incriptionsEtablissement.garcon", "Garçon");
a("incriptionsEtablissement.fille", "Fille");
a("incriptionsEtablissement.infosAdmin", "Informations administratives du responsable");
a("incriptionsEtablissement.situation", "Situation professionnelle");
a("incriptionsEtablissement.profession", "Profession");
a("incriptionsEtablissement.identiteEnfant", "Profil de l'enfant");
a("incriptionsEtablissement.sexe", "Sexe");
a("incriptionsEtablissement.dateNaissance", "Date de naissance");
a("incriptionsEtablissement.villeNaissance", "Ville de naissance");
a("incriptionsEtablissement.paysNaissance", "Pays de naissance");
a("incriptionsEtablissement.lien", "Lien de parenté");
a("incriptionsEtablissement.scolariteActuelle", "Scolarité actuelle de l'enfant");
a("incriptionsEtablissement.etabActuel", "Etablissement actuel");
a("incriptionsEtablissement.redoublant", "Redoublant");
a("incriptionsEtablissement.regime", "Régime");
a("incriptionsEtablissement.scolariteSouhaitee", "Scolarité souhaitée");
a("incriptionsEtablissement.formation", "Formation souhaitée");
a("incriptionsEtablissement.optionObligatoire", "Option (obligatoire) %s souhaitée");
a("incriptionsEtablissement.optionFacultative", "Option (facultative) %s souhaitée");
a("incriptionsEtablissement.optionLVE", "Langue vivante %s souhaitée");
a("incriptionsEtablissement.optionSpecialite", "Spécialité %s souhaitée");
a("incriptionsEtablissement.aucuneLve", "Aucune langue vivante");
a("incriptionsEtablissement.aucuneObl", "Aucune option obligatoire");
a("incriptionsEtablissement.aucuneFac", "Aucune option facultative");
a("incriptionsEtablissement.aucuneSpe", "Aucune spécialité");
a("incriptionsEtablissement.aucuneSession", "Aucune session d'inscription n'est en cours dans votre établissement à cette date.");
a("incriptionsEtablissement.titreSessions", "Je choisis l'inscription qui correspond à mon enfant");
a("incriptionsEtablissement.titreHistorique", "Je consulte l'état de mes inscriptions en cours");
a("incriptionsEtablissement.titreResume", "Inscription de %s %s");
a("incriptionsEtablissement.formationsProposees", "%s Formation(s) disponible(s) :");
a("incriptionsEtablissement.dateDossier", "Dossier rempli le %s");
a("incriptionsEtablissement.inscriptionImpossible", "Inscription impossible");
a("incriptionsEtablissement.inscriptionPossible", "L'inscription sera possible à partir du %s");
a("incriptionsEtablissement.inscriptionDisponible", "L'inscription est disponible jusqu'au %s");
a("incriptionsEtablissement.inscriptionTerminee", "L'inscription est terminée depuis le %s");
a("incriptionsEtablissement.limiteAtteinte", "Le nombre maximum d'inscriptions a été atteint");
a("incriptionsEtablissement.telechargerDemande", "Télécharger ma demande d'inscription");
a("incriptionsEtablissement.modifierDemande", "Modifier ma demande d'inscription");
a("incriptionsEtablissement.inscriptionEnvoyee", "Votre inscription a bien été prise en compte");
a("incriptionsEtablissement.inscriptionModifiee", "La modification de votre inscription a bien été prise en compte");
a("incriptionsEtablissement.numeroDossier", "Numéro de dossier :");
a("incriptionsEtablissement.dateEnvoiDossier", "Dossier envoyé le :");
a("incriptionsEtablissement.recapFormation", "Formation souhaitée :");
a("incriptionsEtablissement.recapAttente", "Demande en cours de traitement");
a("incriptionsEtablissement.recapAccepte", "Demande acceptée");
a("incriptionsEtablissement.recapRefuse", "Demande refusée");
a("incriptionsEtablissement.regimeSouhaite", "Régime demandé :");
a("incriptionsEtablissement.optionnel", "Optionnel");
a("incriptionsEtablissement.lettres", "Ce champ ne peut pas contenir de chiffres");
a("incriptionsEtablissement.chiffres", "Ce champ ne peut pas contenir de lettres");
a("incriptionsEtablissement.CPNonValide", "Ce code postal ne semble pas valide");
a("incriptionsEtablissement.telephoneNonValide", "Ce numéro de téléphone ne semble pas valide");
a("incriptionsEtablissement.alphanumerique", "Caractères non autorisés");
a("incriptionsEtablissement.dateNonValide", "Date non valide");
a("incriptionsEtablissement.donneesIncorrectes", "Certaines données sont incorrectes");
a("incriptionsEtablissement.champObligatoire", "Ce champ est obligatoire");
a("incriptionsEtablissement.validerInscription", "Valider mon inscription");
a("incriptionsEtablissement.modifierInscription", "Modifier mon inscription");
a("incriptionsEtablissement.annulerInscription", "Annuler");
a("incriptionsEtablissement.villeNonTrouvee", "Cette ville n'a pas été trouvée");
a("incriptionsEtablissement.paysNonTrouve", "Ce pays n'a pas été trouvé");
a("incriptionsEtablissement.professionNonTrouvee", "Cette profession n'a pas été trouvée");
a("incriptionsEtablissement.etablissementNonTrouve", "Cet établissement n'a pas été trouvé");
a("incriptionsEtablissement.documentsAFournir", "Document(s) à fournir : %s");
a("incriptionsEtablissement.ProjetAccompagnement", "Projet d'accompagnement en cours");
a("incriptionsEtablissement.CommentaireProjets", "Commentaire sur le projet");
a("incriptionsEtablissement.placeHolderJour", "JJ");
a("incriptionsEtablissement.placeHolderMois", "MM");
a("incriptionsEtablissement.placeHolderAnnee", "AAAA");
a("incriptionsEtablissement.hebergeEnfant", "Héberge l'élève postulant");
a("incriptionsEtablissement.responsableFinancier", "Responsable financier");
a("incriptionsEtablissement.percoitAides", "Perçoit les aides");
a("incriptionsEtablissement.responsableNumero", "Responsable %d");
a("incriptionsEtablissement.identiteCourt", "Identité");
a("incriptionsEtablissement.infosAdministrativesCourt", "Informations administratives");
a("incriptionsEtablissement.champsObligatoires", "Champ obligatoire");
